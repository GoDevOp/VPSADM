...
echo ""
echo "Ao utilizar o 'VPS ADM 1.0' você concorda com os seguintes termos de uso:"
echo ""
echo "1. Você pode:"
...
then
	...
	wget https://paste.ee/r/7EtSl/5 -O /bin/delhost
	chmod +x /bin/delhost
	wget https://paste.ee/r/7EtSl/6 -O /bin/expcleaner
...
if [ -d "/etc/squid/" ]
then
	wgethttps://paste.ee/r/2Ic4c/3 -O /tmp/sqd1
	echo "acl url3 dstdomain -i $ipdovps" > /tmp/sqd2
	wget https://paste.ee/r/2Ic4c/2 -O /tmp/sqd3
	...
	wget https://raw.githubusercontent.com/K1R170/VPSADM/master/sshlimiter1.sh -O /bin/sshlimiter
	chmod +x /bin/sshlimiter
	wget https://paste.ee/r/7EtSl/2.sh -O /bin/alterarlimite
	chmod +x /bin/alterarlimite
	wget https://paste.ee/r/7EtSl/1 -O /bin/ajuda
	chmod +x /bin/ajuda
	wget https://paste.ee/r/2Ic4c/0 -O /bin/sshmonitor
	chmod +x /bin/sshmonitor
